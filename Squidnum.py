...
def menu():
    ...
    print logo
    print ''
    print '\x1b[1;94m[1] \x1b[1;92m Pakistan'
    print '\x1b[1;94m[2]\x1b[1;95m  india'
...
def action():
    global cpb
    global oks
    bch = raw_input('\n\x1b[1;91m\xe2\x95\x90\xe2\x95\x90\xe2\x95\x90\xe2\x95\x90\xe2\x95\x90[BOSS]>  ')
    if bch == '':
        ...
        print logo
        au1=raw_input('\n\t Type Pass 1 : ')
        au2=raw_input('\t Type Pass 2 : ')
        au3=raw_input('\t Type Pass 3 : ')
        ahsanullah = au1+au2+au3
        jalan(' \n================================================  ')
        print'\n\tPassword 1 Type : ',au1
        print"\tPassword 2 Type : ",au2
        print"\tPassword 3 Type : ",au3
        jalan(' \n================================================  ')
        print '\n\x1b[1;93m 01 To ~~49~~'
        try:
